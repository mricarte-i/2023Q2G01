...
def parse_arguments() -> tuple[float, str, str, str, str, str]:
    ...
    return (args.dt, args.static_file, args.dynamic_file, args.xyz_file, args.ovito_file, args.animation_file)