...
public class NaiveNeighbourFindingMethod2DWithWrapAround implements NeighbourFindingMethod<Point2D, Particle2D> {
    ...
    private Map<Particle2D, Collection<Particle2D>> convertVirtualToRealNeighbourhood(Map<VirtualParticle2D, Collection<VirtualParticle2D>> virtualNeighboursMap) {
