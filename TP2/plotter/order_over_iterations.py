...
static_files,     dynamic_files,     polarization_files,     colors_file, out_image_file, min_iter, max_iter = parse_order_over_iterations_arguments()
...
plot_polarization_over_iterations_from_files(static_file_list, dynamic_file_list, polarization_file_list, out_image_file, colors, noises, min_iter, max_iter)