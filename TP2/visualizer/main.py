...
static_file, dynamic_file, lammps_data_file, ovito_file = parse_arguments()
...
generate_frames(simulation_info, lammps_data_file)

# Load xyz file, apply triangle meshes and save simulation
generate_visualization(simulation_info, lammps_data_file, ovito_file)